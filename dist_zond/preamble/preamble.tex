...
%%%Info for title page
\newcommand{\CourseName}{Корпоротивные информационные системы}
\newcommand{\FullCourseNameFirstPart}{\so{КОРПОРАТИВНЫЕ ИНФОРМАЦИОННОЫЕ СИСТЕМЫ}}
\newcommand{\SemesterNumber}{VII}
\newcommand{\LecturerInitials}{Кваснов Антон Васильевич}
\newcommand{\CourseDate}{весна 2023}
\newcommand{\AuthorInitials}{Шкалин Кирилл}
\newcommand{\Lecturership}{Доцент}
