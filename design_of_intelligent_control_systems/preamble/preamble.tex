...
\newcommand{\CourseName}{Проектирование интеллектуальных системм управления}
\newcommand{\FullCourseNameFirstPart}{\so{ПРОЕКТИРОВАНИЕ ИНТЕЛЛЕКТУАЛЬНЫХ СИСТЕМ
УПРАВЛЕНИЯ}}
\newcommand{\SemesterNumber}{VII}
\newcommand{\LecturerInitials}{Кожубаев Юрий Нургачиевич}
